const p = {
  ...
  u = {
    u6: e('var(--font-size-u6)', 'var(--line-height-u6)', 'var(--letter-spacing-u6)'),
    u5: e('var(--font-size-u5)', 'var(--line-height-u5)', 'var(--letter-spacing-u5)'),
    u4: e('var(--font-size-u4)', 'var(--line-height-u4)', 'var(--letter-spacing-u4)'),
    u3: e('var(--font-size-u3)', 'var(--line-height-u3)', 'var(--letter-spacing-u3)'),
    u2: e('var(--font-size-u2)', 'var(--line-height-u2)', 'var(--letter-spacing-u2)'),
    u1: e('var(--font-size-u1)', 'var(--line-height-u1)', 'var(--letter-spacing-u1)'),
    b: e('var(--font-size-b)', 'var(--line-height-b)', 'var(--letter-spacing-b)'),
    d1: e('var(--font-size-d1)', 'var(--line-height-d1)', 'var(--letter-spacing-d1)'),
    d2: e('var(--font-size-d2)', 'var(--line-height-d2)', 'var(--letter-spacing-d2)'),
    d3: e('var(--font-size-d3)', 'var(--line-height-d3)', 'var(--letter-spacing-d3)'),
  },
  g = () => u,
  h = {
    xs: {
...
const z = () =>
  ...
  S = {
    '--font-size-u6':
      'clamp(2.25rem, (100vw - 599px) * 99, clamp(3.5rem, (100vw - 959px) * 99, clamp(4.125rem, (100vw - 1367px) * 99, 4.75rem)))',
    // 36, 56, 66, 76px
    '--font-size-u5':
      'clamp(2rem, (100vw - 599px) * 99, clamp(2.75rem, (100vw - 959px) * 99, clamp(3.25rem, (100vw - 1367px) * 99, 3.75rem)))',
    // 32, 44, 52, 60px
    '--font-size-u4':
      'clamp(1.875rem, (100vw - 599px) * 99, clamp(2.25rem, (100vw - 959px) * 99, clamp(2.5rem, (100vw - 1367px) * 99, 3rem)))',
    // 30, 36, 40, 48px
    '--font-size-u3':
      'clamp(1.5rem, (100vw - 599px) * 99, clamp(1.875rem, (100vw - 959px) * 99, clamp(2.25rem, (100vw - 1367px) * 99, 2.5rem)))',
    // 24, 30, 36, 40px
    '--font-size-u2':
      'clamp(1.25rem, (100vw - 599px) * 99, clamp(1.5rem, (100vw - 959px) * 99, clamp(1.75rem, (100vw - 1367px) * 99, 2rem)))',
    // 20, 24, 28, 32px
  ...
  A = {
    ...
    '--letter-spacing-u5':
      'clamp(-0.083125rem, (100vw - 599px) * 99, clamp(-0.114375rem, (100vw - 959px) * 99, clamp(-0.135625rem, (100vw - 1367px) * 99, -0.15625rem)))',
    '--letter-spacing-u4':
      'clamp(-0.078125rem, (100vw - 599px) * 99, clamp(-0.09375rem, (100vw - 959px) * 99, clamp(-0.078125rem, (100vw - 1367px) * 99, -0.09375rem)))',
    '--letter-spacing-u3':
  ...
  T = {
    '--line-height-u6':
      'clamp(2.5rem, (100vw - 599px) * 99, clamp(4rem, (100vw - 959px) * 99, clamp(4.5rem, (100vw - 1367px) * 99, 5rem)))',
    // 40, 64, 72, 80px
    '--line-height-u5':
      'clamp(2.5rem, (100vw - 599px) * 99, clamp(3rem, (100vw - 959px) * 99, clamp(3.5rem, (100vw - 1367px) * 99, 4rem)))',
    // 40, 48, 56, 64px
    '--line-height-u4':
      'clamp(2rem, (100vw - 599px) * 99, clamp(2.5rem, (100vw - 959px) * 99, clamp(3rem, (100vw - 1367px) * 99, 4rem)))',
    // 32, 40, 48, 64px
    '--line-height-u3':
      'clamp(2rem, (100vw - 599px) * 99, clamp(2.5rem, (100vw - 1367px) * 99, 3rem))',
    // 32, 40, 48px
    '--line-height-u2':
      'clamp(1.5rem, (100vw - 599px) * 99, clamp(2rem, (100vw - 1367px) * 99, 2.5rem))',
    // 24, 32, 40px
